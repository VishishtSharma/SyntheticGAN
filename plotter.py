...
from data_generator import Purpose, DataGenerator


class Plotter:

    def __init__(self, model: Model, data_generator: DataGenerator, sub_dir: str = 'train'):                        #define plot function and initialize directory 
        self.model = model                                                                                                  #to store plots
    ...
    def plot_epoch_result(self, epoch: int, channels: int = 4):                                                     #plotting result of each epoch with 4 channels
